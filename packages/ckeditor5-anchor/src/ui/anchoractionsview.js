...
export default class AnchorActionsView extends View {
	...
	constructor( locale ) {
		...
		/**
		 * Helps cycling over {@anchor #_focusables} in the view.
		 *
		 * @readonly
		 * @protected
	...
	/**
	 * Focuses the fist {@anchor #_focusables} in the actions.
	 */
	focus() {
...
/**
 * Fired when the {@anchor #editButtonView} is clicked.
 *
 * @event edit
 */

/**
 * Fired when the {@anchor #unanchorButtonView} is clicked.
 *
 * @event unanchor
 */
